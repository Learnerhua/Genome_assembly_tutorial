...
${DATA_ROOT}/Download/canu-2.3/bin/ovStoreBuild \
 -O  ./scer.ovlStore.BUILDING \
 -S ../scer.seqStore \
 -C  ./scer.ovlStore.config \
 > ./scer.ovlStore.err 2>&1 \
&& \
mv ./scer.ovlStore.BUILDING ./scer.ovlStore
