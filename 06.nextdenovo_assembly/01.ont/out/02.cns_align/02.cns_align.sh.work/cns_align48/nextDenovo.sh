...
set -xveo pipefail
hostname
cd ${REPO_ROOT}/06.nextdenovo_assembly/01.ont/out/02.cns_align/02.cns_align.sh.work/cns_align48
...
touch ${REPO_ROOT}/06.nextdenovo_assembly/01.ont/out/02.cns_align/02.cns_align.sh.work/cns_align48/nextDenovo.sh.done
