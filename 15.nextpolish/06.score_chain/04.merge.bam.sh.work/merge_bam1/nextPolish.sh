...
set -xveo pipefail
hostname
cd ${REPO_ROOT}/15.nextpolish/06.score_chain/04.merge.bam.sh.work/merge_bam1
...
touch ${REPO_ROOT}/15.nextpolish/06.score_chain/04.merge.bam.sh.work/merge_bam1/nextPolish.sh.done
