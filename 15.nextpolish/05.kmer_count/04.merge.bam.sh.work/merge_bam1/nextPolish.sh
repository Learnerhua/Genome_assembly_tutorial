...
set -xveo pipefail
hostname
cd ${REPO_ROOT}/15.nextpolish/05.kmer_count/04.merge.bam.sh.work/merge_bam1
...
touch ${REPO_ROOT}/15.nextpolish/05.kmer_count/04.merge.bam.sh.work/merge_bam1/nextPolish.sh.done
